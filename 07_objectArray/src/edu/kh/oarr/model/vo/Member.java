...
public class Member {
	...
	// 생성자가 하나라도 잇으면 자동생성 안해줌
	// ->매개변수 생성자는 있다면 기본생성자 직접 작성 해야함!!
	...
	//->private 다른클래스에서 직접접근 불가함.
	//-> 간접접근 방식으로 값을 세팅/얻어올수 있어야함.
	//->그래서 getter/setter 접근제한자가 public임.
	public String getMemberId() {
			//반환형:string 자료형을 메서드호출한곳으로 돌려보내겠다. 
		return memberId;
	...
	public void setMemberId(String memberId) {
		...
		//모든 메서드는 종료 시 호출한 곳으로 돌아감 
		//return; 구문이 작성되더야 하지만 
		//void일 경우 컴팡일러가 자동추가해준다.
	}
