...
import edu.kh.poly.ex2.model.service.HDDCalculator;
import edu.kh.poly.ex2.model.service.KKNCalculator;
...
public class AbstractRun {
	...
	public static void main(String[] args) {
		...
		Calculator cal=  new HDDCalculator();
		...
		// -> 참조변수로는 사용 가능 
		// 코드의 큰 수정 없이 
		// 객체생성 코드만 바꾸면 새로운 클래스 코드를 수행할수 있다. 
		
		// 인터페이스 특징 
		//1) 인터페이스를 부모 참조변수로 사용하면 
		// 다형성 중 업캐스팅 적용되서 
		// 상속받은 모든 클래스를 자식개체로 참조할수 있다. 
		
		//-> 이를 이용하여 중요한 메인코드의 수정을 최소화 할수 있다. 
		
		//2) 자식클래스에 공통된 메서드를 강제 구현하라고 하기 때문에 
		// 모든 자식 ㅡㄹ래스가 동일한 형태를 띄게 된다 
