...
public class User {
	...
	//다른 매개변수 생성자가 있으면 기본생성자 꼭만들어야함 
	
	public User() {
		// 기능
		System.out.println("기본생성자를 user 객체 생성");
	...
	public User(String userId, String userPw , String userName,
		...
		// 가독성이 좀 떨어지는 경우가 잇다. (단점)
		
		this(userId,userPw); //반드시 첫줄에 작성해야함 
...
//	public User(int userAge , String userId) {}
	//매개 변수의 개수 ,타입은 같지만 순서가 다름 
	
//	public User(int userAge , String userName) {};
	//매개 변수 타입 순서가 모두 같아서 불가 
	//-> 변수명은 신경쓰지 않는다. 
