...
//model - 데이터 비즈니스 로직 담당 (모델의 일부로 vo/ DTO)

//view  -  
//

//model - 프로그램 로직과 관련되어있는 데이터를 저장하는 용도, 전부model
...
public class People { // 국민(사람) 클래스
	...
	// 속성 == 값 == data
	// 값을 저장하기 위한 변수 선언 
	// ->국민이라면 공통적으로 가지고 있는 속성만 작성 
	// 이름, 성별, 주민번호 , 주소, 전화번호 , 나이 
	// 필드 == 필드변수 == 멤버변수 
	
	//캡슐화 
	// - 데이터와 기능을 하나로 묶어서 관리하는 기법 
	// - 데이터의 직접 적인 접근을 제한하는 것이 원칙 
	// -> 직접접근 못하기때문에 
...
//[접근제한자] 반환형 메서드명() {}
	...
	public void setName(String name) {
		...
		//** this : 현재객체(현재 클래스)의 this == people.java
		this.name= name;
	}
...
//	alt+ shift +s 또는 상단 메뉴 3번째 source 
