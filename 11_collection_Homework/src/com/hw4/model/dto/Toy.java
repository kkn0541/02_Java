...
public class Toy {
	...
	/**
	 * 아래 tostirng() 에서 재료명 표기 시 사용함 materials 안에 있는 모든 재료를 문자열 형태로 만들어 반환하는 메서드
	 * 
	 * @return
	 */
	public String getMaterialsAsString() {
		...
		// 재료가 있다면 maerials 순회 하면서 재료 하나하나 , 로 구분하여 문자열 만들기
	...
	public String toString() {
		return String.format("이름: %S / 가격 %d / 색상 : %s / 사용가능연령 : %d / 제조년원일 : %s / 재료 : %s", name, price, color, age,
				manufactureDate,  getMaterialsAsString());
	}
