...
public class Array2Example {
	...
	public void ex3() {
		...
		arr[0]= new char[3]; //0 행에 3열짜리 1차원 배열을 생성하여 주소값저장
		arr[1]= new char[4]; //0 행에 4열짜리 1차원 배열을 생성하여 주소값저장
		arr[2]= new char[5]; //0 행에 5열짜리 1차원 배열을 생성하여 주소값저장
		arr[3]= new char[2]; //0 행에 2열짜리 1차원 배열을 생성하여 주소값저장
